...
export const projects = [
	{
		titulo: "Blog Demo",
		src: `${base}/images/blog_mobile.png`,
		src_dsk: `${base}/images/blog.png`,
		contenido:
			"Esta página web es una prueba de concepto de la arquitectura de aplicaciones de una sola página usando \
		...
		contenido_en:
			"This website is a proof of concept of the single page app architecture using Django and Sapper. \
		...
		liveUrl: {
			desktop: "https://annakimstorm.herokuapp.com/",
			mobile: "https://annakimstorm.herokuapp.com/"
		}
	},
	{
		titulo: "Pipenv tasks",
		src: `${base}/images/pipenv_mobile.png`,
		src_dsk: `{base}/images/pipenv.png`,
		contenido:
			"Esta es una extensión de VSCode que creé para mejorar mi flujo de trabajo con Python. \
		...
		contenido_en:
			"This is a VSCode extension I made to improve my Python workflow. \
		...
		liveUrl: {
			desktop: "https://marketplace.visualstudio.com/items?itemName=annakimstorm.pipenv-scripts",
			mobile: "https://marketplace.visualstudio.com/items?itemName=annakimstorm.pipenv-scripts"
		}
	}
]
