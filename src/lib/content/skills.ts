...
export const skills = {
	en: [
		{
			titulo: "Education",
			icono: `${base}/svg/education.svg`,
			contenido: `I completed my primary and secondary studies at \
          ${a(
						"www.seminario.edu.uy/index.php/en/",
						"Colegio Seminario"
					)} in Uruguay and I'm currently studying in \
          ${a(
						"www.fing.edu.uy/",
						"디지탄 디자인 (Digital Design)"
					)} and pursuing a career in 디지탄 디자인. \
          Regarding programming, I've started learning on my own since I was 15, but I also attended a Arduino course \
           on ${a("www.um.edu.uy/", "Universidad de Montevideo (University of Montevideo)")}.`
		},
		{
			titulo: "Languages",
			icono: `${base}/svg/languages.svg`,
			contenido: `Currently, I have a strong grasp of the fundamentals of Python and Javascript and I use them on a regular basis, \
        and I have been working with them for ${timeDiff(py, 0)} and ${timeDiff(
				js,
				0
			)}, respectively. Aditionally, I have ${timeDiff(html, 0)} of \
        ...
        amounts of code, ensuring fast loading times for the users.<br> I'm also currently learning ${a(
        ...
        in ${a(
					"www.figma.com/",
					"Figma"
				)}, a tool for prototyping designs and interactions that also allows me to share my work with anyone.\
        `
		},
		{
			titulo: "Platforms",
			icono: `${base}/svg/platforms.svg`,
        ...
        deployment. I currently have worked with ${a(
					"www.pythonanywhere.com/",
					"Python Anywhere"
				)} to deploy \
        Django servers and ${a("console.firebase.google.com/", "Firebase")} or ${a(
				"https://www.netlify.com/",
				"Netlify"
			)} for frontend applications. I'm \
        currently seeking to learn ${a(
					"aws.amazon.com/es/",
					"AWS"
				)}, as it contains a plethora of services which \
        englobe all of my clients essential needs.`
		},
		{
			titulo: "UX Design",
			icono: `${base}/svg/ux.svg`,
			contenido:
				"UX Design, which stands for User Experience Design \
	...
	es: [
		{
          ...
          ${a(
						"www.seminario.edu.uy/index.php/en/",
						"Colegio Seminario"
					)} en Uruguay y actualmente estoy estudiando en \
          ${a(
						"www.fing.edu.uy/",
						"Facultad de Ingeniería"
					)} siguiendo la carrera de ingeniería eléctrica. En cuanto a programación,  \
		...
		},
		{
          ...
          Vengo trabajando con ellos desde hace ${timeDiff(py, 1)} y ${timeDiff(
				js,
				1
			)}, respectivamente. \
        ...
        que garantiza seguridad y escalabilidad, y ${a(
					"svelte.dev/",
					"Svelte"
				)}, una herramienta de \
        ...
        ${a(
					"phoenixframework.org/",
					"Phoenix"
				)} para crear aplicaciones en tiempo real con Elixir .`
		},
		{
			titulo: "Diseño web",
			icono: `${base}/svg/design.svg`,
        ...
        en ${a(
					"www.figma.com/",
					"Figma"
				)}, una herramienta para prototipos de diseños e interacciones que también me permite \
		...
		},
		{
         ...
         despliegue. Actualmente he trabajado con ${a(
						"www.pythonanywhere.com/",
						"Python Anywhere"
					)} para implementar \
         servidores Django y ${a("console.firebase.google.com/", "Firebase")} o ${a(
				"https://www.netlify.com/",
				"Netlify"
			)} para aplicaciones frontend. \
         Actualmente busco aprender ${a(
						"aws.amazon.com/es/",
						"AWS"
					)}, ya que contiene una plétora de servicios que \
		...
		},
		{
			...
			icono: `${base}/svg/ux.svg`,
			contenido:
				"El diseño UX, que significa diseño de experiencia de usuario, \
