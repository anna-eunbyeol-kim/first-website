<script lang="ts">
	...
	import { activeStore, langStore, lightMode } from "$lib/stores"
...
<nav class="navbar">
	<div class="container">
		<button on:click={() => ($activeStore = "Landing")}>
			<img src="{base}/images/logo.png" alt="Anna Kim" height="50" />
		</button>
		<div class="links">
			...
			<button id="settings" on:click={toggleModal}>
				<img src="{base}/svg/settings.svg" alt="Settings" width="20" height="20" />
			</button>
			<button class="menu" on:click={toggleOverlay}>
				<img src="{base}/svg/hamburger.svg" alt="Menu" width="30" height="18" />
			</button>
		</div>
	</div>
</nav>
...
{#if overlay}
	<aside transition:fly={{ x: 500, duration: 300, easing: circInOut }} id="sidenav">
		<button class="close" on:click={toggleOverlay}>
			<img src="{base}/svg/close.svg" alt="Close" />
		</button>
	...
	<div class="modal" in:fade={{ duration: 300 }}>
		<header>
			...
			<button on:click={() => (showModal = false)} id="close">
				<img src="{base}/svg/close.svg" alt="Close" width="22" height="22" />
			</button>
		</header>
		<p>
			<img src="{base}/svg/night.svg" alt="Switch to Dark Theme" width="30" height="30" />
			<!-- <Switch bind:checked={$lightMode} /> -->
			<img src="{base}/svg/day.svg" alt="Switch to Light Theme" width="30" height="30" />
		</p>
		<p>
			<img src="{base}/images/en.png" alt="Switch to English" width="30" height="20" />
			<Switch bind:checked={langBuffer} />
			<img src="{base}/images/es.png" alt="Cambiar a español" width="30" height="20" />
		</p>
	</div>
{/if}
