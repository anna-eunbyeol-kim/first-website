	...
	@keyframes dotSpin {
		...
		12.5% {
			box-shadow: 0 -18px 0 -5px rgba(152, 128, 255, 0), 12.72984px -12.72984px 0 0 #3498db,
				18px 0 0 0 #3498db, 12.72984px 12.72984px 0 0 #3498db, 0 18px 0 -5px rgba(152, 128, 255, 0),
				-12.72984px 12.72984px 0 -5px rgba(152, 128, 255, 0), -18px 0 0 -5px rgba(152, 128, 255, 0),
				-12.72984px -12.72984px 0 -5px rgba(152, 128, 255, 0);
		}
		25% {
		...
		37.5% {
			box-shadow: 0 -18px 0 -5px rgba(152, 128, 255, 0),
				12.72984px -12.72984px 0 -5px rgba(152, 128, 255, 0), 18px 0 0 -5px rgba(152, 128, 255, 0),
				12.72984px 12.72984px 0 0 #3498db, 0 18px 0 0 #3498db, -12.72984px 12.72984px 0 0 #3498db,
		...
		62.5% {
			box-shadow: 0 -18px 0 -5px rgba(152, 128, 255, 0),
				12.72984px -12.72984px 0 -5px rgba(152, 128, 255, 0), 18px 0 0 -5px rgba(152, 128, 255, 0),
				12.72984px 12.72984px 0 -5px rgba(152, 128, 255, 0), 0 18px 0 -5px rgba(152, 128, 255, 0),
				-12.72984px 12.72984px 0 0 #3498db, -18px 0 0 0 #3498db, -12.72984px -12.72984px 0 0 #3498db;
		}
		75% {
